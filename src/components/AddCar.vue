      ...
      <div class="col-sm-4">
        <form @submit.prevent="addCar">
          <div class="form-group">
            ...
            <input v-model="car.brand" type="text" class="form-control" id="brand" placeholder="Enter brand">
          </div>
           <div class="form-group">
            <label for="name">Model</label>
            <input v-model="car.model" type="text" class="form-control" id="model" placeholder="Enter model">
          </div>
        <label>Year:</label>
        ...
        <input v-model="car.numberOfDoors" type="number" class="form-control" id="numberOfDoors" placeholder="Enter numberOfDoors">
        </div>
        <div class="form-group">
        ...
        <label for="name"> is Automatic </label>
         <input type="checkbox" value="test" v-model="car.isAutomatic">
